...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("document_type", :stored_searchable),              label: AIC.documentType.label
    config.add_index_field solr_name("first_document_sub_type", :stored_searchable),    label: AIC.documentSubType1.label
    config.add_index_field solr_name("second_document_sub_type", :stored_searchable),   label: AIC.documentSubType2.label
