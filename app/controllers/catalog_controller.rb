...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    # config.add_index_field solr_name("document_types", :stored_searchable),  label: AIC.documentType.label, link_to_search: solr_name("document_types", :stored_searchable).to_sym

    config.add_index_field solr_name("document_types", :stored_searchable),  label: AIC.documentType.label, helper_method: :link_to_each_type
